...
class InspirationGenerator {
    ...
    renderLibrarySelector() {
        ...
        const footerSysCredits = document.getElementById('footer-system-credits');
        if (footerSysCredits) {
            const showSysCredits = !!(systemLib && this.selectedLibraries.includes(systemLib.bindingId));
            footerSysCredits.classList.toggle('hidden', !showSysCredits);
            footerSysCredits.setAttribute('aria-hidden', showSysCredits ? 'false' : 'true');
        }
